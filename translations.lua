...
local translations =
  {
    ...
    ["report.legend.1"] =
      {
    ["en"] = "• = PEF before medication\n∆ = Daily variation % and l/min",
    ["fi"] = "• = PEF ennen lääkettä\n∆ = Päivittäisvaihtelu % and l/min"
      },

    ["report.legend.2"] =
      {
    ["en"] = "• = PEF after medication\n∆ = Bronchodilatation response % and l/min",
    ["fi"] = "• = PEF lääkkeen jälkeen\n∆ = Bronkodilataatiovaste % and l/min"
      },

    ["report.legend.3"] =
      {
    ["en"] = "∆ = Significant difference",
    ["fi"] = "∆ = Merkittävä poikkeama"
      },
